...
{
    // load shaders
    ResourceManager::LoadShader("data/shaders/sprite.vs", "data/shaders/sprite.fs", nullptr, "sprite");
    ResourceManager::LoadShader("data/shaders/particle.vs", "data/shaders/particle.fs", nullptr, "particle");
    ResourceManager::LoadShader("data/shaders/post_processing.vs", "data/shaders/post_processing.fs", nullptr, "postprocessing");
    // configure shaders
    ...
    ResourceManager::LoadTexture("data/textures/ball.png", true, "ball");
    ...
    // load levels
    GameLevel one; one.Load("data/levels/one.lvl", this->Width, this->Height / 2);
    GameLevel two; two.Load("data/levels/two.lvl", this->Width, this->Height / 2);
    GameLevel three; three.Load("data/levels/three.lvl", this->Width, this->Height / 2);
    GameLevel four; four.Load("data/levels/four.lvl", this->Width, this->Height / 2);
...
{
    if (this->Level == 0)
        this->Levels[0].Load("data/levels/one.lvl", this->Width, this->Height / 2);
    else if (this->Level == 1)
        this->Levels[1].Load("data/levels/two.lvl", this->Width, this->Height / 2);
    else if (this->Level == 2)
        this->Levels[2].Load("data/levels/three.lvl", this->Width, this->Height / 2);
    else if (this->Level == 3)
        this->Levels[3].Load("data/levels/four.lvl", this->Width, this->Height / 2);
...
{
    if (ShouldSpawn(15)) // 1 in 75 chance
